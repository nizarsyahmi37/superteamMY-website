...
export function ViewsMembersHero({ totalMembers, totalAchievements }: HeroProps) {
	return (
		<section className="relative overflow-hidden py-16 md:py-24">
			...
			<div className="absolute top-0 right-0 w-96 h-96 bg-super-yellow/10 rounded-full blur-3xl" />
			<div className="absolute bottom-0 left-0 w-64 h-64 bg-super-yellow/5 rounded-full blur-2xl" />
